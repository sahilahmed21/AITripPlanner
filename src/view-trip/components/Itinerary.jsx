...
const Itinerary = ({ trip }) => {
  ...
  // Check if trip or itinerary exists before rendering
  if (!trip || !trip.tripData || !trip.tripData.itinerary || trip.tripData.itinerary.length === 0) {
    return (
      <div className="container mx-auto px-6 py-12 w-4/5 text-center">
        <h2 className="text-2xl font-bold">No Itinerary Available</h2>
      </div>
    );
  }
