...
const CreateTrip = () => {
  ...
  const SaveAiTrip = async (TripData) => {
    ...
    navigate("/gemini/dist/view-trip/" + docId);
  };
    ...
    <div className="flex flex-col justify-center items-center bg-gradient-to-b from-blue-100 to-gray-100 min-h-screen py-8 px-4">
      ...
      <div className="mt-8 text-center w-full max-w-2xl">
        ...
        <p className="text-gray-700 text-lg mb-8">
          Share your travel preferences by providing a few details below.
          This will enable our AI Assistant to offer personalized recommendations and enhance your travel experience.
        </p>
      </div>
